package com.aedeo.quizviewbarang;
...
import com.aedeo.quizviewbarang.MainActivity;
...
//        MainActivity.mTextView.setText(s);
        ListAdapter adapter = new SimpleAdapter(MainActivity.mContext, listItems, R.layout.list_item, new String[]{"id", "nama", "harga", "stock"}, new int[]{R.id.id, R.id.nama, R.id.harga, R.id.stock});
